document.addEventListener('DOMContentLoaded', () => {
    ...
    fetchData().then(jsonfile => {
        ...
        function getRandomInt() {
            ...
            if (usedChallenges.length === numberOfItems) {
                usedChallenges = [];
                alert('All challenges have been used. Restarting!');
            }

            // Find a random challenge that has not been used yet
            let randomIndex;
            do {
                randomIndex = Math.floor(Math.random() * numberOfItems);
        ...
        document.addEventListener('click', function(event) {
            ...
            let cardText = malaSuerteItems[number]['card'];
